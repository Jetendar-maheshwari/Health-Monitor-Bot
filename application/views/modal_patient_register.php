                    ...
                    <div class="row">
                        <div class="col-md-9 col-sm-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="firstname" type="text" class="form-control" id="firstname" placeholder="<?php echo display('first_name') ?>" value="" >
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="lastname" type="text" class="form-control" id="lastname" placeholder="<?php echo display('last_name') ?>" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="email" type="text" class="form-control" id="email" placeholder="<?php echo display('email') ?>" value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="phone" class="form-control" type="text" placeholder="<?php echo display('phone') ?>" id="phone"  value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="mobile" class="form-control" type="text" placeholder="<?php echo display('mobile') ?>" id="mobile"  value="">
                                </div>
                            </div>
                                ...
                                <div class="col-xs-9">
                                    <div class="form-check">
                                        <label class="radio-inline">
                                            <input type="radio" name="sex"  ><?php echo display('male') ?>
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="sex"  ><?php echo display('female') ?>
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="sex"  ><?php echo display('other') ?>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-xs-9">
                                    <input name="date_of_birth" class="datepicker form-control" type="text" placeholder="<?php echo display('date_of_birth') ?>" id="date_of_birth"  value="">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <label for="postal_code" class="col-xs-3 col-form-label"> <?php echo display('postal_code') ?> <i class="text-danger">*</i></label>
                                <div class="col-xs-9">
                                    <input name="postal_code" class="form-control" type="text" placeholder="<?php echo display('postal_code') ?>" id="postal_code"  value="">
                                </div>
                            </div>
