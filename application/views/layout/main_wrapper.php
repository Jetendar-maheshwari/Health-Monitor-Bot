        ...
        <div class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="<?php echo (($this->uri->segment(1) == 'dashboard') ? "active" : null) ?>">
                    <a href="<?php echo base_url('dashboard/home') ?>"><i class="fa fa-home"></i> <?php echo display('dashboard') ?></a>
                </li>

                <li class="treeview <?php echo (($this->uri->segment(1) == "department") ? "active" : null) ?>">
                    <a href="#">
                        <i class="fa fa-building"></i> <span><?php echo display('department') ?></span>
                ...
                <li class="treeview <?php echo (($this->uri->segment(1) == "symptoms") ? "active" : null) ?>">
                    <a href="#">
                        <i class="fa fa-tint"></i> <span><?php echo display('symptoms') ?></span>
                        <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                    </a>
                ...
                <li class="treeview <?php echo (($this->uri->segment(1) == "setting" || $this->uri->segment(1) == "language") ? "active" : null) ?>">
                    <a href="#">
                        <i class="fa fa-cogs"></i> <span><?php echo display('setting') ?></span>
                        <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                    </a>
                ...
                <li class="treeview <?php echo (($this->uri->segment(1) == "messages") ? "active" : null) ?>">
                    <a href="#">
                        <i class="fa fa-comments"></i> <span><?php echo display('messages') ?></span>
                        <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                    </a>
                ...
                <li class="treeview <?php echo (($this->uri->segment(1) == "mail") ? "active" : null) ?>">
                    <a href="#">
                        <i class="fa fa-envelope"></i> <span><?php echo display('mail') ?></span>
                        <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                    </a>
...
<script src="<?php echo base_url() ?>assets/js/backend.js" type="text/javascript"></script>
</body>
</html>