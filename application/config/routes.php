...
$route['symptoms/(:num)/questions'] = 'question/index/$1';
$route['symptoms/(:num)/questions/create'] = 'question/create/$1';
$route['symptoms/(:num)/questions/edit/(:num)'] = 'question/edit/$1/$2';
$route['symptoms/(:num)/questions/delete/(:num)'] = 'question/delete/$1/$2';
